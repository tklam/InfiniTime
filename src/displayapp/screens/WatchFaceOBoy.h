...
namespace Pinetime {
  ...
  namespace Applications {
    namespace Screens {
      ...
      class WatchFaceOBoy : public Screen {
      public:
        WatchFaceOBoy(Controllers::DateTime& dateTimeController,
      ...
      private:
        ...
        lv_point_t line_day_of_week_number_points[4] {{0, 0}, {93, 0}, {93, 93}, {0, 93}};
